/* ============================================
   DREAM DAY — HomePage (actualizado)
   
   Ahora usa ServicioCard con imágenes Cloudinary.
   ACTUALIZADO: guarda categoriaAnticipacion en el carrito
...
function HomePage() {
  ...
  function handleAgregar(servicio) {
    var agregado = carritoStorage.agregar({
      ...
      categoriaAnticipacion: servicio.categoria ? (servicio.categoria.anticipacionMinimaDias || 0) : 0,
