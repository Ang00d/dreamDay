/* ============================================
   ...
   ACTUALIZADO: Calcula fecha mínima dinámica
   según la anticipación mínima por categoría.
   Ej: Si el carrito tiene Comida (7 días), la fecha
   mínima será hoy + 7 días, no hoy + 1.
   ============================================ */
...
function PasoFecha({ fecha, horaInicio, personas, servicios, onUpdate, onAvisosChange }) {
  ...
  var anticipacionInfo = useMemo(function () {
    var maxDias = 1; // mínimo 1 día (mañana)
  ...
  return (
    <div>
      ...
      {/* ★ Aviso de anticipación mínima (siempre visible si hay categorías con anticipación) */}
      ...
      <div className="paso-fecha-grid">
        ...
        <div className="form-field">
          ...
          <input
            type="date"
            value={fecha}
            min={anticipacionInfo.fechaMinima}
            onChange={handleFechaChange}
          />
          <span className="field-hint">
            {anticipacionInfo.categorias.length > 0
              ? 'Mínimo ' + anticipacionInfo.maxDias + ' días de anticipación por tus servicios'
