...
// ORDEN IMPORTANTE:
// 1. Routers específicos ANTES del admin general (para que tomen precedencia en sus métodos)
// 2. El admin general al final maneja lo que no capturó ningún router específico
