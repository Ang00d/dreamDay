/* ============================================
   ...
   ACTUALIZADO: método obtenerMesCarrito para
   consultar disponibilidad filtrada por servicios
   ============================================ */
...
var disponibilidadService = {
  ...
  /**
   * Obtener calendario de un mes filtrado por servicios del carrito
   ...
   *   🟡 amarillo: algunos ocupados
   *   🔴 rojo: todos los del carrito ocupados
   */
  obtenerMesCarrito: async function (anio, mes, serviciosIds) {
    var response = await api.get('/disponibilidad/mes-carrito', {
      params: {
        anio: anio,
        mes: mes,
