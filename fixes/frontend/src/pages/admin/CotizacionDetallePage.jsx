...
export default function CotizacionDetallePage() {
  ...
  var cambiarEstado = async function (nuevoEstado) {
    ...
    try {
      await adminService.actualizarCotizacion(id, { estado: nuevoEstado });
  ...
  var canCancel = ['cancelada', 'rechazada'].indexOf(cot.estado) === -1;

  var totalEstimado = servicios.reduce(function (sum, s) {
    var precio = s.precioUnitario || s.servicioId?.precio || 0;
    var cantidad = s.cantidad || 1;
  ...
  return (
    <div className="det-page">
      ...
      <div className="det-card">
        ...
        <div className="det-servicios-list">
          {servicios.map(function (s, i) {
            var nombre = s.servicioId?.nombre || s.nombre || 'Servicio ' + (i + 1);
            var precio = s.precioUnitario || s.servicioId?.precio || 0;
            var cantidad = s.cantidad || 1;
            ...
            return (
              <div key={i} className="det-servicio-item">
                <div className="det-servicio-info">
                  ...
                  <span className="det-servicio-cantidad">
                    {'Cantidad: ' + cantidad}
                  </span>
                </div>
                <div className="det-servicio-precios">
                  <span className="det-servicio-unitario">
                    {formatPrecio(precio) + ' c/u'}
                  </span>
                  <span className="det-servicio-subtotal">
      ...
      <div className="det-actions">
        ...
        {canCancel && cot.estado !== 'confirmada' && (
          <button
