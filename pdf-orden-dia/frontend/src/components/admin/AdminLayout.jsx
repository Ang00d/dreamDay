...
export default function AdminLayout() {
  ...
  const todosLosItems = [
    ...
    { to: '/admin/orden-del-dia',  icon: <ClipboardList size={20} />,   label: 'Orden del día',   roles: ['superadmin', 'admin', 'editor'] },
    { to: '/admin/disponibilidad', icon: <Calendar size={20} />,        label: 'Disponibilidad',  roles: ['superadmin', 'admin'] },
    { to: '/admin/categorias',     icon: <FolderTree size={20} />,      label: 'Categorías',      roles: ['superadmin', 'admin'] },
